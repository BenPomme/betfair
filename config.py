...
DISCORD_PROGRESS_DIGEST_ENABLED: bool = os.getenv("DISCORD_PROGRESS_DIGEST_ENABLED", "true").lower() == "true"
DISCORD_PROGRESS_DIGEST_INTERVAL_MINUTES: int = int(os.getenv("DISCORD_PROGRESS_DIGEST_INTERVAL_MINUTES", "60"))
...
SCAN_MARKET_TYPES: str = os.getenv(
    "SCAN_MARKET_TYPES",
    "MATCH_ODDS,DRAW_NO_BET,OVER_UNDER_05,OVER_UNDER_15,OVER_UNDER_25,OVER_UNDER_35,OVER_UNDER_45,OVER_UNDER_55,OVER_UNDER_65,BOTH_TEAMS_TO_SCORE,CORRECT_SCORE,HALF_TIME,HALF_TIME_SCORE,DOUBLE_CHANCE,ASIAN_HANDICAP,TO_QUALIFY",
)
SCAN_MAX_HOURS_AHEAD: int = int(os.getenv("SCAN_MAX_HOURS_AHEAD", "72"))
...
BETFAIR_EVENT_MATCH_MIN_CONFIDENCE: float = float(os.getenv("BETFAIR_EVENT_MATCH_MIN_CONFIDENCE", "0.65"))
...
POLYMARKET_BINARY_RESEARCH_LABEL_HORIZON_SECONDS: int = int(
    os.getenv("POLYMARKET_BINARY_RESEARCH_LABEL_HORIZON_SECONDS", "120")
)
POLYMARKET_BINARY_RESEARCH_MIN_SCORE: float = float(
    os.getenv("POLYMARKET_BINARY_RESEARCH_MIN_SCORE", "-0.01")
)
POLYMARKET_QF_ENABLED: bool = os.getenv("POLYMARKET_QF_ENABLED", "false").lower() == "true"
POLYMARKET_QF_INITIAL_BALANCE_USD: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_INITIAL_BALANCE_USD", "7500")
)
POLYMARKET_QF_SPORTS_FILTER: str = os.getenv(
    "POLYMARKET_QF_SPORTS_FILTER", "soccer,basketball,tennis,football,baseball,hockey"
)
POLYMARKET_QF_MAX_EVENTS: int = int(os.getenv("POLYMARKET_QF_MAX_EVENTS", "250"))
POLYMARKET_QF_LABEL_HORIZONS_SECONDS: str = os.getenv(
    "POLYMARKET_QF_LABEL_HORIZONS_SECONDS", "120,600,1800"
)
POLYMARKET_QF_PRIMARY_HORIZON_SECONDS: int = int(
    os.getenv("POLYMARKET_QF_PRIMARY_HORIZON_SECONDS", "600")
)
POLYMARKET_QF_MIN_EDGE_AFTER_COSTS: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_MIN_EDGE_AFTER_COSTS", "0.015")
)
POLYMARKET_QF_MAX_OPEN_POSITIONS: int = int(os.getenv("POLYMARKET_QF_MAX_OPEN_POSITIONS", "5"))
POLYMARKET_QF_MAX_POSITIONS_PER_EVENT: int = int(
    os.getenv("POLYMARKET_QF_MAX_POSITIONS_PER_EVENT", "1")
)
POLYMARKET_QF_MAX_NOTIONAL_PER_TRADE_USD: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_MAX_NOTIONAL_PER_TRADE_USD", "150")
)
POLYMARKET_QF_DRAWDOWN_HALT_PCT: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_DRAWDOWN_HALT_PCT", "6")
)
POLYMARKET_QF_MAX_HOLD_SECONDS: int = int(os.getenv("POLYMARKET_QF_MAX_HOLD_SECONDS", "1800"))
POLYMARKET_QF_STALE_QUOTE_SECONDS: int = int(
    os.getenv("POLYMARKET_QF_STALE_QUOTE_SECONDS", "30")
)
POLYMARKET_QF_FEE_BUFFER_BPS: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_FEE_BUFFER_BPS", "20")
)
POLYMARKET_QF_QUEUE_PENALTY_BPS: Decimal = Decimal(
    os.getenv("POLYMARKET_QF_QUEUE_PENALTY_BPS", "8")
)
POLYMARKET_QF_CLOB_HTTP_BASE_URL: str = os.getenv(
    "POLYMARKET_QF_CLOB_HTTP_BASE_URL", "https://clob.polymarket.com"
)
POLYMARKET_QF_CLOB_WS_URL: str = os.getenv(
    "POLYMARKET_QF_CLOB_WS_URL", "wss://ws-subscriptions-clob.polymarket.com/ws"
)
POLYMARKET_QF_CLOB_WS_ENABLED: bool = os.getenv(
    "POLYMARKET_QF_CLOB_WS_ENABLED", "true"
).lower() == "true"
POLYMARKET_QF_HTTP_TIMEOUT_SECONDS: float = float(
    os.getenv("POLYMARKET_QF_HTTP_TIMEOUT_SECONDS", "10.0")
)
POLYMARKET_QF_MATCH_MARKETS_ONLY: bool = os.getenv(
    "POLYMARKET_QF_MATCH_MARKETS_ONLY", "true"
).lower() == "true"
POLYMARKET_QF_MAX_SETTLEMENT_HOURS: int = int(
    os.getenv("POLYMARKET_QF_MAX_SETTLEMENT_HOURS", "168")
)
POLYMARKET_QF_BOOK_UNIVERSE_SIZE: int = int(
    os.getenv("POLYMARKET_QF_BOOK_UNIVERSE_SIZE", "80")
)
POLYMARKET_QF_MAX_TRACKED_TOKENS: int = int(
    os.getenv("POLYMARKET_QF_MAX_TRACKED_TOKENS", "18")
)
POLYMARKET_QF_EXAMPLE_INTERVAL_SECONDS: int = int(
    os.getenv("POLYMARKET_QF_EXAMPLE_INTERVAL_SECONDS", "60")
)
POLYMARKET_QF_HISTORY_INTERVAL: str = os.getenv("POLYMARKET_QF_HISTORY_INTERVAL", "1m")
POLYMARKET_QF_HISTORY_FIDELITY: int = int(os.getenv("POLYMARKET_QF_HISTORY_FIDELITY", "60"))
POLYMARKET_QF_HISTORY_REFRESH_SECONDS: int = int(
    os.getenv("POLYMARKET_QF_HISTORY_REFRESH_SECONDS", "60")
)
POLYMARKET_QF_READINESS_MIN_LABELED: int = int(
    os.getenv("POLYMARKET_QF_READINESS_MIN_LABELED", "250")
)
POLYMARKET_QF_READINESS_MIN_CLOSED_TRADES: int = int(
    os.getenv("POLYMARKET_QF_READINESS_MIN_CLOSED_TRADES", "50")
)
THESPORTSDB_ENABLED: bool = os.getenv("THESPORTSDB_ENABLED", "true").lower() == "true"
THESPORTSDB_HTTP_BASE_URL: str = os.getenv(
    "THESPORTSDB_HTTP_BASE_URL", "https://www.thesportsdb.com"
)
THESPORTSDB_API_KEY: str = os.getenv("THESPORTSDB_API_KEY", "123")
THESPORTSDB_LOOKAHEAD_DAYS: int = int(os.getenv("THESPORTSDB_LOOKAHEAD_DAYS", "2"))
...
PREDICTION_POLICY_GATE_ENABLED: bool = os.getenv("PREDICTION_POLICY_GATE_ENABLED", "true").lower() == "true"
PREDICTION_POLICY_GATE_PATH: str = os.getenv(
    "PREDICTION_POLICY_GATE_PATH", "data/models/prediction_policy_gate_v1.json"
)
PREDICTION_POLICY_GATE_MIN_EXAMPLES: int = int(
    os.getenv("PREDICTION_POLICY_GATE_MIN_EXAMPLES", "150")
)
PREDICTION_POLICY_GATE_MIN_TEST_EXAMPLES: int = int(
    os.getenv("PREDICTION_POLICY_GATE_MIN_TEST_EXAMPLES", "50")
)
PREDICTION_POLICY_GATE_MIN_TEST_BETS: int = int(
    os.getenv("PREDICTION_POLICY_GATE_MIN_TEST_BETS", "20")
)
PREDICTION_POLICY_GATE_TRAIN_FRACTION: Decimal = Decimal(
    os.getenv("PREDICTION_POLICY_GATE_TRAIN_FRACTION", "0.7")
)
PREDICTION_POLICY_GATE_MIN_ROI: Decimal = Decimal(
    os.getenv("PREDICTION_POLICY_GATE_MIN_ROI", "0.0")
)
PREDICTION_POLICY_GATE_MIN_BRIER_LIFT: Decimal = Decimal(
    os.getenv("PREDICTION_POLICY_GATE_MIN_BRIER_LIFT", "0.0")
)
PREDICTION_POLICY_GATE_SHADOW_STAKE_MULTIPLIER: Decimal = Decimal(
    os.getenv("PREDICTION_POLICY_GATE_SHADOW_STAKE_MULTIPLIER", "0.10")
)
PREDICTION_POLICY_GATE_SHADOW_FAIL_STAKE_MULTIPLIER: Decimal = Decimal(
    os.getenv("PREDICTION_POLICY_GATE_SHADOW_FAIL_STAKE_MULTIPLIER", "0.05")
)
