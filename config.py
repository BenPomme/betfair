...
POLYMARKET_QF_MAX_SPREAD_BPS: float = float(
    os.getenv("POLYMARKET_QF_MAX_SPREAD_BPS", "250.0")
)
POLYMARKET_QF_MIN_ASK_DEPTH_MULTIPLE: float = float(
    os.getenv("POLYMARKET_QF_MIN_ASK_DEPTH_MULTIPLE", "1.25")
)
...
CASCADE_ALPHA_POLICY_DISABLE_SETUP_MIN_SETTLED: int = int(
    os.getenv("CASCADE_ALPHA_POLICY_DISABLE_SETUP_MIN_SETTLED", "10")
)
CASCADE_ALPHA_POLICY_DISABLE_SETUP_MAX_AVG_NET_PNL_USD: Decimal = Decimal(
    os.getenv("CASCADE_ALPHA_POLICY_DISABLE_SETUP_MAX_AVG_NET_PNL_USD", "-0.25")
)
