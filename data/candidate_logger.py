...
def build_strategy_record(
    *,
    ...
    polymarket_confirmed: bool = False,
    match_confidence: float = 0.0,
    quote_freshness_sec: Optional[float] = None,
    event_confirmation_level: str = "low",
    expected_half_life_sec: Optional[float] = None,
    forward_pnl_2s: Optional[float] = None,
    forward_pnl_5s: Optional[float] = None,
    forward_pnl_15s: Optional[float] = None,
    forward_pnl_60s: Optional[float] = None,
    net_pnl_after_friction: Optional[float] = None,
    strategy_context: Optional[dict] = None,
    candidate_id: Optional[str] = None,
) -> dict:
    return {
        "ts": datetime.now(timezone.utc),
        "record_type": "strategy_candidate",
        ...
        "polymarket_confirmed": polymarket_confirmed,
        "match_confidence": match_confidence,
        "quote_freshness_sec": quote_freshness_sec,
        "event_confirmation_level": event_confirmation_level,
        "expected_half_life_sec": expected_half_life_sec,
        "forward_pnl_2s": forward_pnl_2s,
        "forward_pnl_5s": forward_pnl_5s,
        "forward_pnl_15s": forward_pnl_15s,
        "forward_pnl_60s": forward_pnl_60s,
        "net_pnl_after_friction": net_pnl_after_friction,
